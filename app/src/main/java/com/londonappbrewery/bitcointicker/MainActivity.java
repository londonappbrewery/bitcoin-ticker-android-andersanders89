    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                letsDoSomeNetworking("" + parent.getItemAtPosition(position));
            }
        ...
        client.get(BASE_URL + url, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "Error Updating Price", Toast.LENGTH_SHORT);
                    Log.d("Bitcoin", e.toString());
                }
            }
